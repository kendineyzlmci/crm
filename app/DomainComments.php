...
class DomainComments extends Model
{
    use SoftDeletes;
    ...
    public function getLikeControlAttribute(){
        ...
        $like = DomainCommentsLike::where('comment_id',$this->id)->where('user_id',Auth::id())->count();
        if($like<=0){
            return "beğenmemiş";
        }else{
            return "yellow-text";
    ...
    public function getLikeCountAttribute(){
        ...
        return DomainCommentsLike::where('comment_id',$this->id)->count();
