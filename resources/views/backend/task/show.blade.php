...
@section('headersubcontent')
    <div class="col s10 m6 l6">
        <h5 class="breadcrumbs-title mt-0 mb-0"><span>Görev Detayları</span></h5>
    </div>
    <div class="col s2 m6 l6">
        ...
        <a href="{{ route('tasks.edit',['id'=>$taskInfo->id]) }}" class="ml-3 btn-floating waves-effect waves-light cyan tooltipped right" data-position="bottom" data-tooltip="Düzenle"><i class="material-icons left">edit</i></a>
    </div>
@endsection
@section('content')
    <div class="section users-view">
            ...
            <div class="row">
                    ...
                    <div class="display-flex media">
                        ...
                        <div class="media-body">
                            <h6 class="media-heading">
                                <span class="users-view-name" style="font-size: 1.70rem;">{{ $taskInfo->title }}</span>
                            </h6>
                            <span class="users-view-id">
                                <b>Son Güncelleme :</b> {{ $taskInfo->taskUpdatedAt }} - <b>Kalan Süre : </b>{{ $taskInfo->Deadline }}
                            </span>
                        </div>
                    </div>
                </div>
                <div class="col s12 m5 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                    <div class="display-flex media">
                        <div class="media-body">
                            <span class="users-view-id">
                                <span class="chip {{ $taskInfo->taskStatus['color'] }} lighten-5">
                                    <span class="{{ $taskInfo->taskStatus['color'] }}-text">{{$taskInfo->taskStatus['is_active']}}</span>
                                </span>
                                <span class="chip {{ $taskInfo->taskPriority['color'] }} lighten-5">
                ...
                <ul class="tabs row">
                    <li class="tab">
                        <a class="display-flex align-items-center active" id="account-tab" href="#taskinfo">
                            <i class="material-icons mr-1">info</i><span>Görev Bilgileri</span>
                        </a>
                    </li>
                    <li class="tab">
        ...
        @include('backend.task.info')
        @include('backend.task.comment')
        @include('backend.task.file')
