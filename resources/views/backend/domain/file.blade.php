<div id="documents">
    <div class="card">
        ...
        <div class="card-content" id="documentcancel">
            <form class="row" method="POST" action="{{ route('domainfiles.store') }}" enctype="multipart/form-data" >
                @csrf
        ...
        <div class="card-content app-file-area">
            <div class="app-file-content">
                <div class="row app-file-recent-access mb-3">
                    @foreach(\App\DomainFiles::where('domain_id',$domainInfo->id)->orderBy('id','desc')->get() as $key => $value)
                                ...
                                <div class="card-content">
                                    <div class="app-file-content-logo grey lighten-4">
                                        <div class="fonticon">
                                            ...
                                            <a href="{{ route('domainfiles.destroy',['id'=>$value->id]) }}" class="tooltipped red-text" data-position="bottom" data-tooltip="Sil"><i class="material-icons">delete</i></a>
                                        </div>
